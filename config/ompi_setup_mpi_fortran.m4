...
AC_DEFUN([OMPI_SETUP_MPI_FORTRAN],[
    ...
    OMPI_FORTRAN_CHECK([REAL], [yes],
                   [short float, float, double, long double, opal_short_float_t], [-1], [yes])
    OMPI_FORTRAN_CHECK([REAL*2], [no],
                   [short float, float, double, long double, opal_short_float_t], [2], [yes])
    OMPI_FORTRAN_CHECK([REAL*4], [no],
                   [short float, float, double, long double, opal_short_float_t], [4], [yes])
    OMPI_FORTRAN_CHECK([REAL*8], [no],
                   [short float, float, double, long double, opal_short_float_t], [8], [yes])
    OMPI_FORTRAN_CHECK([REAL*16], [no],
                   [short float, float, double, long double, opal_short_float_t], [16], [yes])
    ...
    OMPI_FORTRAN_CHECK([COMPLEX], [yes], [short float _Complex, float _Complex, double _Complex, opal_short_float_complex_t], [-1], [no])
    ...
    OMPI_FORTRAN_CHECK([COMPLEX*4], [no], [short float _Complex, float _Complex, opal_short_float_complex_t], [4], [no])
